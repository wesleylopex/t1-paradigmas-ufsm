...
<body class="overflow-x-hidden bg-gray-100">
  <main class="w-screen min-h-screen grid place-items-center px-2 md:px-0">
    <div class="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
      ...
      <?php endif ?>
      <h1 class="text-dark font-medium text-xl">Recuperação de senha</h1>
      <p class="text-gray-500 mt-2 mb-4 text-sm">Digite seu email, enviaremos um link para você alterar sua senha</p>
      <form action="<?= base_url('forgotPassword/handle') ?>" method="get" class="w-full grid grid-cols-1 gap-4">
        <div>
        ...
        <div>
          <button class="btn btn--primary w-full">Enviar email</button>
